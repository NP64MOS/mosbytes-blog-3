      ...
      <main className="dark-blue-gradient text-white overflow-hidden">
        ...
        <section ref={containerRef} className="relative min-h-screen flex items-center justify-center">
          ...
          >
            ...
            <motion.p
              className="text-lg sm:text-xl lg:text-2xl text-gray-100 mb-8 max-w-3xl mx-auto leading-relaxed font-medium"
            ...
            >
              <div className="text-center sm:text-left">
                ...
                >
                  <Link
                    href="/blog"
                    className="group relative inline-flex items-center justify-center px-8 sm:px-10 py-4 text-base sm:text-lg font-bold text-white bg-gradient-to-r from-glow-blue to-blue-glow rounded-full overflow-hidden transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-glow-blue/40 shadow-2xl glow-blue"
                ...
                <p className="text-xs sm:text-sm amber-glow-text mt-2 font-medium">
              ...
              >
                <Link
                  href="/dashboard"
                  className="inline-flex items-center justify-center px-6 sm:px-8 py-4 text-base sm:text-lg font-semibold text-warm-amber border-2 border-warm-amber/50 rounded-full hover:border-warm-amber hover:text-amber-glow hover:bg-warm-amber/10 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-warm-amber/20 backdrop-blur-sm"
            ...
            >
              <div className="flex flex-col items-center space-y-4">
                <blockquote className="text-center max-w-2xl bg-navy-800/40 backdrop-blur-sm rounded-xl p-6 border border-glow-blue/30 glow-blue">
                  <p className="text-sm sm:text-base text-gray-100 italic font-medium">
                    "MOSBytes made AI accessible to me. The tutorials are clear, practical, and I'm already using AI tools in my daily work."
                  </p>
                  <footer className="mt-3 text-xs sm:text-sm blue-glow-text font-semibold">
        ...
        {/* Features Section */}
        <section className="py-20 sm:py-32 bg-gradient-to-b from-navy-black to-navy-800 relative">
              ...
              {features.map((feature) => (
                ...
                >
                  <div className="relative bg-gradient-to-br from-navy-800/70 to-navy-700/50 backdrop-blur-sm border border-glow-blue/30 rounded-2xl p-6 sm:p-8 h-full overflow-hidden group-hover:border-glow-blue/50 transition-all duration-300">
                    ...
                    <motion.div
                      className={`w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br ${feature.gradient} rounded-xl mb-6 flex items-center justify-center transition-all duration-300 group-hover:shadow-lg`}
                      whileHover={{
                        scale: 1.15,
                        rotate: 8,
        ...
        <footer className="bg-navy-black border-t border-glow-blue/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            {/* Bottom Bar */}
            <div className="border-t border-glow-blue/30 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center">
